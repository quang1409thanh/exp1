						  ...
						  xpu_datum_t *__result)
{
	...
	{
		const uint8_t *bitmap = (const uint8_t *)((const char *)kds + cmeta->values_offset);
...
isinf(float2_t fval) { return isinf(fp16_to_fp32(fval)); }
INLINE_FUNCTION(bool)
isnan(float2_t fval) { return isnan(fp16_to_fp32(fval)); }
INLINE_FUNCTION(int)
lrinth(float2_t fval) { return rintf(fp16_to_fp32(fval)); }
INLINE_FUNCTION(bool)
__iszero(float2_t fval) { return fp16_to_fp32(fval) == 0.0; }
INLINE_FUNCTION(bool)
__iszero(float4_t fval) { return fval == 0.0; }
INLINE_FUNCTION(bool)
__iszero(float8_t fval) { return fval == 0.0; }
