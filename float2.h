...
#ifdef __cplusplus
INLINE_FUNCTION(float2_t)
__to_fp16(float2_t fval) { return fval; }
INLINE_FUNCTION(float2_t)
__to_fp16(float4_t fval) { return fp32_to_fp16(fval); }
INLINE_FUNCTION(float2_t)
__to_fp16(float8_t fval) { return fp64_to_fp16(fval); }

INLINE_FUNCTION(float4_t)
__to_fp32(float2_t fval) { return fp16_to_fp32(fval); }
INLINE_FUNCTION(float4_t)
__to_fp32(float4_t fval) { return fval; }
INLINE_FUNCTION(float4_t)
__to_fp32(float8_t fval) { return (float)fval; }

INLINE_FUNCTION(float8_t)
__to_fp64(float2_t fval) { return fp16_to_fp64(fval); }
INLINE_FUNCTION(float8_t)
__to_fp64(float4_t fval) { return (double)fval; }
INLINE_FUNCTION(float8_t)
__to_fp64(float8_t fval) { return fval; }
